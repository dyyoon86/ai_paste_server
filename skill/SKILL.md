...
- `icon`(선택): 그 장면을 한눈에 보여주는 **이모지 1개**. 내용에 맞게 골라라 (예: 시간 🕐, 완료 ✅, 아이디어 💡, 데이터 📊, 경고 ⚠️, 돈 💰, 위치 📍). 중앙에 크게 등장한다. 없으면 생략.
- `points`(선택, 권장): 화면 중앙에 **순차로 뜨는 짧은 요약 타이포 2~4개**. 각 항목 **2~10자**의 키워드/구. narration(음성)을 그대로 옮기지 말고 **핵심만 압축**해라. (예: narration "결제자마다 따로 발급되는 1회용 계좌번호예요" → points: ["1회용 계좌번호", "결제자별 발급"])
...
---BEGIN_VIDEO_SPEC_JSON---
{
  ...
  "scenes": [
    { "id": 1, "start": 0, "end": 3, "screen_text": "0.3초", "narration": "결제 한 건이 승인되기까지 걸리는 시간, 단 0.3초입니다.", "visual_direction": "큰 카운트다운 숫자 중앙, 빨간 글로우 펄스", "transition": "fade", "effect": "punch-in" },
    { "id": 2, "start": 3, "end": 6, "screen_text": "수백만 건", "narration": "그 짧은 순간에도 수백만 건이 동시에 일어납니다.", "visual_direction": "카운터가 위로 빠르게 증가", "transition": "slide", "effect": "punch-in" },
    { "id": 3, "start": 6, "end": 9, "screen_text": "그 속에서", "narration": "이 거대한 흐름 속에서 문제는 단 하나입니다.", "visual_direction": "수많은 거래 행이 흐르는 화면", "transition": "slide", "effect": "none" },
    { "id": 4, "start": 9, "end": 12, "screen_text": "이상 거래 포착", "narration": "수상한 거래 하나를 FDS가 집어냅니다.", "visual_direction": "한 행이 빨간색으로 강조되며 확대", "transition": "zoom", "effect": "punch-in" },
    { "id": 5, "start": 12, "end": 15, "screen_text": "룰 엔진", "narration": "먼저 정해진 규칙으로 1차 검사하고,", "visual_direction": "룰 카드가 등장", "transition": "slide", "effect": "none" },
    { "id": 6, "start": 15, "end": 18, "screen_text": "ML 분석", "narration": "머신러닝이 평소 패턴과 비교합니다.", "visual_direction": "그래프가 그려지는 모션", "transition": "slide", "effect": "none" },
    { "id": 7, "start": 18, "end": 21, "screen_text": "위험도 계산", "narration": "둘을 합쳐 위험 점수를 매깁니다.", "visual_direction": "점수 게이지가 차오름", "transition": "zoom", "effect": "none" },
    { "id": 8, "start": 21, "end": 24, "screen_text": "즉시 차단", "narration": "기준을 넘으면 결제는 그 자리에서 멈춥니다.", "visual_direction": "빨간 차단 표시가 쾅 등장", "transition": "cut", "effect": "punch-in" },
    { "id": 9, "start": 24, "end": 27, "screen_text": "결제는 안전", "narration": "정상 거래는 0.3초 안에 그대로 통과합니다.", "visual_direction": "초록 통과 체크", "transition": "fade", "effect": "none" },
    { "id": 10, "start": 27, "end": 30, "screen_text": "차단 완료 ✅", "narration": "위험은 막히고, 당신의 결제는 지켜집니다.", "visual_direction": "초록 배지가 중앙에 등장, calm fade out", "transition": "fade", "effect": "punch-out" }
  ],
  "assets": [],
